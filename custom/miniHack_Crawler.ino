...
const char *ssid = "miniHack_Crawler";
const char *password = "";
...
void DRV8835_Control(){
    ...
    if (drive_mode == 1){
     ...
     for (int i=0; i < 100; i++){
      analogWrite(AIN1,(int)-0.0255*i^2+255 );
      analogWrite(AIN2,255);
      analogWrite(BIN1,(int)-0.0255*i^2+255);
      analogWrite(BIN2,255);
      delay(WAIT);
      }      
    ...
    if (drive_mode == 2){
      for (int i=0; i < 100; i++){
      analogWrite(AIN1,0);
      analogWrite(AIN2,(int)-0.0255*i^2+255);
      analogWrite(BIN1,0);
      analogWrite(BIN2,(int)-0.0255*i^2+255);
      delay(WAIT);
      }
      analogWrite(AIN1,255);
